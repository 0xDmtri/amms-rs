...
impl ERC4626Vault {
    ...
    pub async fn new_from_address<N, P>(vault_token: Address, provider: P) -> Result<Self, AMMError>
    where
        N: Network,
        P: Provider<N> + Clone,
    {
    ...
    pub async fn get_reserves<N, P>(&self, provider: P) -> Result<(U256, U256), AMMError>
    where
        N: Network,
        P: Provider<N> + Clone,
    {
